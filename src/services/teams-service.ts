...
const getTeams = async (
  ...
  /*try {
    const response = await api.get(`/teams?league=${leagueId}&season=${seasonYear}`, makeConfig(key));
    ...
    response: [
      ...
      },
      {
        team: {
          ...
          founded: 1881,
          national: false,
          logo: "https://media-2.api-sports.io/football/teams/38.png",
        },
        venue: {
          id: 596,
          name: "Vicarage Road",
      ...
      },
      {
        ...
        venue: {
          ...
          capacity: 32050,
          surface: "grass",
          image: "https://media-1.api-sports.io/football/venues/600.png",
        },
      },
      {
        team: {
      ...
      },
      {
        ...
        venue: {
          ...
          capacity: 32689,
          surface: "grass",
          image: "https://media-1.api-sports.io/football/venues/585.png",
        },
      },
      {
        team: {
        ...
        venue: {
          ...
          capacity: 60383,
          surface: "grass",
          image: "https://media-2.api-sports.io/football/venues/494.png",
        },
      },
      {
        team: {
        ...
        venue: {
          ...
          capacity: 22546,
          surface: "grass",
          image: "https://media-2.api-sports.io/football/venues/512.png",
        },
      },
      {
        team: {
      ...
      },
      {
        ...
        venue: {
          ...
          capacity: 34310,
          surface: "grass",
          image: "https://media-1.api-sports.io/football/venues/547.png",
        },
      },
      {
        team: {
      ...
      },
      {
        ...
        venue: {
          ...
          capacity: 31800,
          surface: "grass",
          image: "https://media-1.api-sports.io/football/venues/508.png",
        },
      },
      {
        team: {
      ...
      },
      {
        ...
        venue: {
          ...
          capacity: 17250,
          surface: "grass",
          image: "https://media-2.api-sports.io/football/venues/10503.png",
        },
      },
      {
        team: {
      ...
      },
      {
        ...
        venue: {
          ...
          capacity: 42788,
          surface: "grass",
          image: "https://media-1.api-sports.io/football/venues/495.png",
        },
      },
      {
        team: {
        ...
        venue: {
          ...
          capacity: 27606,
          surface: "grass",
          image: "https://media-1.api-sports.io/football/venues/565.png",
        },
      },
    ],
  };

  const resultMap = result.response.map((item) => {
